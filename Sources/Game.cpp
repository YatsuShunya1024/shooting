...
// TODO: 砲台の位置を画面左に、ターゲットの位置を画面右に移動させる。(A)//黒津
// TODO: 雲の位置を左から右に動かす。見えなくなったら左端に戻す。(B)//森本
// TODO: 砲台を青い壁に沿って上下に動かす。(C)//谷津
// TODO: 弾のスピードを速くし、弾が画面右端を通り越したら再度発射可能にする。(D)//新甚
// TODO: スコアのサイズを大きくする。(E)//谷津
// TODO: スコアを100点ずつ加算するようにし、5桁の表示に変える。(F)//新甚
// TODO: PlayBGM()関数を使って、BGMを再生する。(G)//森本
// TODO: PlaySound()関数を使って、弾の発射時とターゲットに当たった時にSEを再生する。(H)//黒津
